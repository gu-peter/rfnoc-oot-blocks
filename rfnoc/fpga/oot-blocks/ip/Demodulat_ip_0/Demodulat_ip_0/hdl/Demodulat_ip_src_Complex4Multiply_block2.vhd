-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_src_Complex4Multiply_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_src_Complex4Multiply_block2
-- Source Path: dsphdl.FFT/RADIX22FFT_SDF1_9/Complex4Multiply
-- Hierarchy Level: 5
-- Model version: 8.98
-- 
-- -------------------------------------------------------------
...
ENTITY Demodulat_ip_src_Complex4Multiply_block2 IS
...
END Demodulat_ip_src_Complex4Multiply_block2;


ARCHITECTURE rtl OF Demodulat_ip_src_Complex4Multiply_block2 IS

  -- Signals
  SIGNAL din_re_signed                    : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL din_re_reg                       : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL din_im_signed                    : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL din_im_reg                       : signed(40 DOWNTO 0);  -- sfix41_En30
  ...
  SIGNAL Complex4Multiply_din1_re_pipe1   : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41
  SIGNAL Complex4Multiply_din1_im_pipe1   : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41
  SIGNAL Complex4Multiply_mult1_re_pipe1  : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73
  SIGNAL Complex4Multiply_mult2_re_pipe1  : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73
  SIGNAL Complex4Multiply_mult1_im_pipe1  : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73
  SIGNAL Complex4Multiply_mult2_im_pipe1  : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73
  ...
  SIGNAL prod1_re                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En60
  SIGNAL prod1_im                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En60
  SIGNAL prod2_re                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En60
  SIGNAL prod2_im                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En60
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(73 DOWNTO 0);  -- sfix74_En60
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(73 DOWNTO 0);  -- sfix74_En60
  SIGNAL Complex4Add_sub_cast             : signed(73 DOWNTO 0);  -- sfix74_En60
  SIGNAL Complex4Add_sub_cast_1           : signed(73 DOWNTO 0);  -- sfix74_En60
  SIGNAL Complex4Add_add_cast             : signed(73 DOWNTO 0);  -- sfix74_En60
  SIGNAL Complex4Add_add_cast_1           : signed(73 DOWNTO 0);  -- sfix74_En60
  SIGNAL mulResFP_re                      : signed(73 DOWNTO 0);  -- sfix74_En60
  SIGNAL mulResFP_im                      : signed(73 DOWNTO 0);  -- sfix74_En60
  SIGNAL dinXTwdl_9_1_vld_1               : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL dinXTwdl_im_tmp                  : signed(40 DOWNTO 0);  -- sfix41_En30
