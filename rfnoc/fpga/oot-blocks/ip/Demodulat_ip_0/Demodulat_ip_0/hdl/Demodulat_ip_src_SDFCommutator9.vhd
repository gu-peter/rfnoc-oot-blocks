-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_src_SDFCommutator9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_src_SDFCommutator9
-- Source Path: dsphdl.FFT/RADIX22FFT_SDF1_9/SDFCommutator9
-- Hierarchy Level: 5
-- Model version: 8.98
-- 
-- -------------------------------------------------------------
...
ENTITY Demodulat_ip_src_SDFCommutator9 IS
...
END Demodulat_ip_src_SDFCommutator9;


ARCHITECTURE rtl OF Demodulat_ip_src_SDFCommutator9 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL xf_im_signed                     : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL dinXTwdlf_re_signed              : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL dinXTwdlf_im_signed              : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL btf1_re_signed                   : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL btf1_im_signed                   : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL btf2_re_signed                   : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL btf2_im_signed                   : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL SDFCummutator_out_re             : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL SDFCummutator_out_im             : signed(40 DOWNTO 0);  -- sfix41
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL SDFCummutator_wrData_im_reg      : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(40 DOWNTO 0);  -- sfix41
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL SDFCummutator_out_im_next        : signed(40 DOWNTO 0);  -- sfix41_En30
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(40 DOWNTO 0);  -- sfix41_En30
  ...
  SIGNAL wrData_re_tmp                    : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL wrData_im_tmp                    : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL wrAddr_tmp                       : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL xData_re                         : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL xData_im                         : signed(40 DOWNTO 0);  -- sfix41_En30
  ...
  SIGNAL dout0_re                         : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL dout0_im                         : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(40 DOWNTO 0);  -- ufix41
  SIGNAL xX_re_signed                     : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL xX_im                            : std_logic_vector(40 DOWNTO 0);  -- ufix41
  SIGNAL xX_im_signed                     : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_9_1_re_tmp                  : signed(40 DOWNTO 0);  -- sfix41_En30
  SIGNAL dout_9_1_im_tmp                  : signed(40 DOWNTO 0);  -- sfix41_En30

BEGIN
  u_dataXMEM_re_0_9 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataXMEM_im_0_9 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 41
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(0, 41);
      SDFCummutator_out_im <= to_signed(0, 41);
      SDFCummutator_wrData_re_reg <= to_signed(0, 41);
      SDFCummutator_wrData_im_reg <= to_signed(0, 41);
      ...
      SDFCummutator_wrXData_re_reg <= to_signed(0, 41);
      SDFCummutator_wrXData_im_reg <= to_signed(0, 41);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        SDFCummutator_wrXData_re_reg_next <= to_signed(0, 41);
        SDFCummutator_wrXData_im_reg_next <= to_signed(0, 41);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(0, 41);
      SDFOutmux_btf2Pipe_im <= to_signed(0, 41);
