...
ENTITY Demodulat_ip_src_CPRemoval_stage1 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        tmp_re                            :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
        tmp_im                            :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
        tmp                               :   IN    std_logic;
        tmp_1                             :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16_En15
        varargout_1_re                    :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
        varargout_1_im                    :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
...
ARCHITECTURE rtl OF Demodulat_ip_src_CPRemoval_stage1 IS
  ...
  SIGNAL tmp_re_signed                    : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_im_signed                    : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataReg_re : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataReg_im : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataInReg_re : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataInReg_im : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_re_2                         : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_im_2                         : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataInReg1_re : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataInReg1_im : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataInReg2_re : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataInReg2_im : signed(31 DOWNTO 0);  -- sfix32_En30
  ...
  SIGNAL obj_CPRemoval_stage1Obj_dataOutReg_re : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataOutReg_im : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_re_5                         : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_im_5                         : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataOutReg1_re : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataOutReg1_im : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataOutReg2_re : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataOutReg2_im : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataOut_re : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_CPRemoval_stage1Obj_dataOut_im : signed(31 DOWNTO 0);  -- sfix32_En30
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      obj_CPRemoval_stage1Obj_dataReg_re <= to_signed(0, 32);
      obj_CPRemoval_stage1Obj_dataReg_im <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      obj_CPRemoval_stage1Obj_dataInReg_re <= to_signed(0, 32);
      obj_CPRemoval_stage1Obj_dataInReg_im <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      obj_CPRemoval_stage1Obj_dataInReg1_re <= to_signed(0, 32);
      obj_CPRemoval_stage1Obj_dataInReg1_im <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      obj_CPRemoval_stage1Obj_dataInReg2_re <= to_signed(0, 32);
      obj_CPRemoval_stage1Obj_dataInReg2_im <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      obj_CPRemoval_stage1Obj_dataOutReg_re <= to_signed(0, 32);
      obj_CPRemoval_stage1Obj_dataOutReg_im <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      obj_CPRemoval_stage1Obj_dataOutReg1_re <= to_signed(0, 32);
      obj_CPRemoval_stage1Obj_dataOutReg1_im <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      obj_CPRemoval_stage1Obj_dataOutReg2_re <= to_signed(0, 32);
      obj_CPRemoval_stage1Obj_dataOutReg2_im <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      obj_CPRemoval_stage1Obj_dataOut_re <= to_signed(0, 32);
      obj_CPRemoval_stage1Obj_dataOut_im <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
