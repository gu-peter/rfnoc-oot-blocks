-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_src_SDFCommutator2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_src_SDFCommutator2
-- Source Path: dsphdl.FFT/RADIX22FFT_SDF2_2/SDFCommutator2
-- Hierarchy Level: 5
-- Model version: 8.98
-- 
-- -------------------------------------------------------------
...
ENTITY Demodulat_ip_src_SDFCommutator2 IS
...
END Demodulat_ip_src_SDFCommutator2;


ARCHITECTURE rtl OF Demodulat_ip_src_SDFCommutator2 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL xf_im_signed                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL dinf_re_signed                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL dinf_im_signed                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL btf1_re_signed                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL btf1_im_signed                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL btf2_re_signed                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL btf2_im_signed                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL SDFCummutator_out_re             : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL SDFCummutator_out_im             : signed(33 DOWNTO 0);  -- sfix34
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL SDFCummutator_wrData_im_reg      : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(33 DOWNTO 0);  -- sfix34
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL SDFCummutator_out_im_next        : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL wrData_re_tmp                    : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL wrData_im_tmp                    : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL wrAddr_tmp                       : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL xData_re                         : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL xData_im                         : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL dout0_re                         : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL dout0_im                         : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL xX_re_signed                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL xX_im                            : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL xX_im_signed                     : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_2_1_re_tmp                  : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL dout_2_1_im_tmp                  : signed(33 DOWNTO 0);  -- sfix34_En30

BEGIN
  u_dataXMEM_re_0_2 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataXMEM_im_0_2 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 34
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(0, 34);
      SDFCummutator_out_im <= to_signed(0, 34);
      SDFCummutator_wrData_re_reg <= to_signed(0, 34);
      SDFCummutator_wrData_im_reg <= to_signed(0, 34);
      ...
      SDFCummutator_wrXData_re_reg <= to_signed(0, 34);
      SDFCummutator_wrXData_im_reg <= to_signed(0, 34);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        SDFCummutator_wrXData_re_reg_next <= to_signed(0, 34);
        SDFCummutator_wrXData_im_reg_next <= to_signed(0, 34);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(0, 34);
      SDFOutmux_btf2Pipe_im <= to_signed(0, 34);
