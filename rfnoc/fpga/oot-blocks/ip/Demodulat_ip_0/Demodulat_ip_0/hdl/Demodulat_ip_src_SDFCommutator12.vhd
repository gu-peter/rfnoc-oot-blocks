-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_src_SDFCommutator12.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_src_SDFCommutator12
-- Source Path: dsphdl.FFT/RADIX22FFT_SDF2_12/SDFCommutator12
-- Hierarchy Level: 5
-- Model version: 8.101
-- 
-- -------------------------------------------------------------
...
ENTITY Demodulat_ip_src_SDFCommutator12 IS
...
END Demodulat_ip_src_SDFCommutator12;


ARCHITECTURE rtl OF Demodulat_ip_src_SDFCommutator12 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL xf_im_signed                     : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL dinf_re_signed                   : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL dinf_im_signed                   : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL btf1_re_signed                   : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL btf1_im_signed                   : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL btf2_re_signed                   : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL btf2_im_signed                   : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFCummutator_out_re             : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_out_im             : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_wrData_im_reg      : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(27 DOWNTO 0);  -- sfix28
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_btf1_im_dly        : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFCummutator_btf1_vld_dly       : std_logic;
  SIGNAL SDFCummutator_out_re_next        : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFCummutator_out_im_next        : signed(27 DOWNTO 0);  -- sfix28_En14
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(27 DOWNTO 0);  -- sfix28_En14
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL wrData_im_tmp                    : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL xData_re                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL xData_im                         : signed(27 DOWNTO 0);  -- sfix28_En14
  ...
  SIGNAL dout0_re                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL dout0_im                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL xX_re_signed                     : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL xX_im                            : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL xX_im_signed                     : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(27 DOWNTO 0);  -- sfix28
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_12_1_re_tmp                 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL dout_12_1_im_tmp                 : signed(27 DOWNTO 0);  -- sfix28_En14

BEGIN
  u_dataXMEM_re_0_12 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataXMEM_im_0_12 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 28
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(16#0000000#, 28);
      SDFCummutator_out_im <= to_signed(16#0000000#, 28);
      SDFCummutator_wrData_re_reg <= to_signed(16#0000000#, 28);
      SDFCummutator_wrData_im_reg <= to_signed(16#0000000#, 28);
      SDFCummutator_wrEnb_reg <= '0';
      SDFCummutator_out_vld <= '0';
      SDFCummutator_wrState <= to_unsigned(16#0#, 3);
      SDFCummutator_wrAddr_reg <= '0';
      SDFCummutator_wrXData_re_reg <= to_signed(16#0000000#, 28);
      SDFCummutator_wrXData_im_reg <= to_signed(16#0000000#, 28);
      ...
      SDFCummutator_btf1_re_dly <= to_signed(16#0000000#, 28);
      SDFCummutator_btf1_im_dly <= to_signed(16#0000000#, 28);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      ...
      WHEN "100" =>
        ...
        END IF;
      WHEN OTHERS => 
        SDFCummutator_wrXData_re_reg_next <= to_signed(16#0000000#, 28);
        SDFCummutator_wrXData_im_reg_next <= to_signed(16#0000000#, 28);
        SDFCummutator_xWrAddr_next <= to_unsigned(16#0#, 3);
        SDFCummutator_xRdAddr_next <= to_unsigned(16#0#, 3);
        SDFCummutator_wrxEnb_reg_next <= '0';
        SDFCummutator_XState_next <= to_unsigned(16#0#, 3);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(16#0000000#, 28);
      SDFOutmux_btf2Pipe_im <= to_signed(16#0000000#, 28);
  ...
  BEGIN
    ...
    END IF;
    dout_12_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_12_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_12_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_12_1_re <= std_logic_vector(dout_12_1_re_tmp);

  dout_12_1_im <= std_logic_vector(dout_12_1_im_tmp);
