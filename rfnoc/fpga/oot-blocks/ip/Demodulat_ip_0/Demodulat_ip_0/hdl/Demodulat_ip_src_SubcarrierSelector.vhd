...
ARCHITECTURE rtl OF Demodulat_ip_src_SubcarrierSelector IS
  ...
  SIGNAL obj_SubcarrierSelectorObj_dataOut_re : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataOut_im : signed(27 DOWNTO 0);  -- sfix28_En14
  ...
  SIGNAL obj_SubcarrierSelectorObj_dataIn_re : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataIn_im : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_re                           : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_im                           : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataIn_re_1 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataIn_im_1 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataOut_re_1 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataOut_im_1 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataOut_re_2 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataOut_im_2 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataOut_re_3 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL obj_SubcarrierSelectorObj_dataOut_im_3 : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_re_1                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_im_1                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_re_2                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_im_2                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_re_3                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_im_3                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_re_4                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_im_4                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_re_5                         : signed(27 DOWNTO 0);  -- sfix28_En14
  SIGNAL tmp_im_5                         : signed(27 DOWNTO 0);  -- sfix28_En14
...
BEGIN
  ...
  obj_SubcarrierSelectorObj_dataOut_re <= to_signed(16#0000000#, 28);
  obj_SubcarrierSelectorObj_dataOut_im <= to_signed(16#0000000#, 28);
  ...
  obj_SubcarrierSelectorObj_dataIn_re <= to_signed(16#0000000#, 28);
  obj_SubcarrierSelectorObj_dataIn_im <= to_signed(16#0000000#, 28);
  ...
  BEGIN
    IF reset = '1' THEN
      obj_SubcarrierSelectorObj_dataIn_re_1 <= to_signed(16#0000000#, 28);
      obj_SubcarrierSelectorObj_dataIn_im_1 <= to_signed(16#0000000#, 28);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  obj_SubcarrierSelectorObj_dataOut_re_1 <= to_signed(16#0000000#, 28);
  obj_SubcarrierSelectorObj_dataOut_im_1 <= to_signed(16#0000000#, 28);

  -- HDL code generation from MATLAB function: SystemCore_stepImpl_trueregionp71
  obj_SubcarrierSelectorObj_dataOut_re_2 <= to_signed(16#0000000#, 28);
  obj_SubcarrierSelectorObj_dataOut_im_2 <= to_signed(16#0000000#, 28);
  ...
  BEGIN
    IF reset = '1' THEN
      obj_SubcarrierSelectorObj_dataOut_re_3 <= to_signed(16#0000000#, 28);
      obj_SubcarrierSelectorObj_dataOut_im_3 <= to_signed(16#0000000#, 28);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
