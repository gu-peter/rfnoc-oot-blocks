-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_fifo_data_OUT_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_fifo_data_OUT_block
-- Source Path: Demodulat_ip/Demodulat_ip_axis_a_master/Demodulat_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Demodulat_ip_fifo_data_OUT_block IS
...
END Demodulat_ip_fifo_data_OUT_block;


ARCHITECTURE rtl OF Demodulat_ip_fifo_data_OUT_block IS

  -- Component Declarations
  COMPONENT Demodulat_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : Demodulat_ip_SimpleDualPortRAM_generic
    USE ENTITY work.Demodulat_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_Demodulat_ip_fifo_data_OUT_classic_ram : Demodulat_ip_SimpleDualPortRAM_generic
