-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_src_SDFCommutator11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_src_SDFCommutator11
-- Source Path: dsphdl.FFT/RADIX22FFT_SDF1_11/SDFCommutator11
-- Hierarchy Level: 5
-- Model version: 8.98
-- 
-- -------------------------------------------------------------
...
ENTITY Demodulat_ip_src_SDFCommutator11 IS
...
END Demodulat_ip_src_SDFCommutator11;


ARCHITECTURE rtl OF Demodulat_ip_src_SDFCommutator11 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL xf_im_signed                     : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL dinXTwdlf_re_signed              : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL dinXTwdlf_im_signed              : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL btf1_re_signed                   : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL btf1_im_signed                   : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL btf2_re_signed                   : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL btf2_im_signed                   : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL SDFCummutator_out_re             : signed(42 DOWNTO 0);  -- sfix43
  SIGNAL SDFCummutator_out_im             : signed(42 DOWNTO 0);  -- sfix43
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(42 DOWNTO 0);  -- sfix43
  SIGNAL SDFCummutator_wrData_im_reg      : signed(42 DOWNTO 0);  -- sfix43
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(42 DOWNTO 0);  -- sfix43
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(42 DOWNTO 0);  -- sfix43
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL SDFCummutator_out_im_next        : signed(42 DOWNTO 0);  -- sfix43_En30
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(42 DOWNTO 0);  -- sfix43_En30
  ...
  SIGNAL wrData_re_tmp                    : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL wrData_im_tmp                    : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL xData_re                         : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL xData_im                         : signed(42 DOWNTO 0);  -- sfix43_En30
  ...
  SIGNAL dout0_re                         : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL dout0_im                         : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL xX_re_signed                     : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL xX_im                            : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL xX_im_signed                     : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(42 DOWNTO 0);  -- sfix43
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(42 DOWNTO 0);  -- sfix43
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_11_1_re_tmp                 : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL dout_11_1_im_tmp                 : signed(42 DOWNTO 0);  -- sfix43_En30

BEGIN
  u_dataXMEM_re_0_11 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataXMEM_im_0_11 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 43
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(0, 43);
      SDFCummutator_out_im <= to_signed(0, 43);
      SDFCummutator_wrData_re_reg <= to_signed(0, 43);
      SDFCummutator_wrData_im_reg <= to_signed(0, 43);
      SDFCummutator_wrEnb_reg <= '0';
      SDFCummutator_out_vld <= '0';
      SDFCummutator_wrState <= to_unsigned(16#0#, 3);
      SDFCummutator_wrAddr_reg <= '0';
      SDFCummutator_wrXData_re_reg <= to_signed(0, 43);
      SDFCummutator_wrXData_im_reg <= to_signed(0, 43);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        SDFCummutator_wrXData_re_reg_next <= to_signed(0, 43);
        SDFCummutator_wrXData_im_reg_next <= to_signed(0, 43);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(0, 43);
      SDFOutmux_btf2Pipe_im <= to_signed(0, 43);
  ...
  BEGIN
    ...
    END IF;
    dout_11_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_11_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_11_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_11_1_re <= std_logic_vector(dout_11_1_re_tmp);

  dout_11_1_im <= std_logic_vector(dout_11_1_im_tmp);
