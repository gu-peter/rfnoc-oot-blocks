-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_fifo_data_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_fifo_data_block
-- Source Path: Demodulat_ip/Demodulat_ip_axis_a_slave/Demodulat_ip_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Demodulat_ip_fifo_data_block IS
...
END Demodulat_ip_fifo_data_block;


ARCHITECTURE rtl OF Demodulat_ip_fifo_data_block IS
...
BEGIN
  ...
  u_Demodulat_ip_fifo_data_classic_ram : Demodulat_ip_SimpleDualPortRAM_generic
