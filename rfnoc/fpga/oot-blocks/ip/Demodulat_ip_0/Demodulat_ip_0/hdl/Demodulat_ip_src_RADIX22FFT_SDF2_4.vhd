-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_src_RADIX22FFT_SDF2_4
-- Source Path: dsphdl.FFT/RADIX22FFT_SDF2_4
-- Hierarchy Level: 4
-- Model version: 8.98
-- 
-- -------------------------------------------------------------
...
ENTITY Demodulat_ip_src_RADIX22FFT_SDF2_4 IS
...
END Demodulat_ip_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF Demodulat_ip_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT Demodulat_ip_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          xf_im                           :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          dinf_im                         :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          btf1_im                         :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          btf2_re                         :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          btf2_im                         :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          wrData_im                       :   OUT   std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
  ...
  FOR ALL : Demodulat_ip_src_SDFCommutator4
    USE ENTITY work.Demodulat_ip_src_SDFCommutator4(rtl);

  -- Signals
  SIGNAL dout_3_1_re_signed               : signed(34 DOWNTO 0);  -- sfix35_En30
  SIGNAL din_re                           : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL dout_3_1_im_signed               : signed(34 DOWNTO 0);  -- sfix35_En30
  SIGNAL din_im                           : signed(35 DOWNTO 0);  -- sfix36_En30
  ...
  SIGNAL btf2_im                          : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL btf2_re                          : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL btf1_im                          : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL btf1_re                          : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL dinf_im                          : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL dinf_re                          : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL xf_im                            : signed(35 DOWNTO 0);  -- sfix36_En30
  ...
  SIGNAL x_im_signed                      : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL x_im_dly                         : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL wrData_re                        : std_logic_vector(35 DOWNTO 0);  -- ufix36
  SIGNAL x_re                             : std_logic_vector(35 DOWNTO 0);  -- ufix36
  SIGNAL x_re_signed                      : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL x_re_dly                         : signed(35 DOWNTO 0);  -- sfix36_En30
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(36 DOWNTO 0);  -- sfix37_En30
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(36 DOWNTO 0);  -- sfix37_En30
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(36 DOWNTO 0);  -- sfix37_En30
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(36 DOWNTO 0);  -- sfix37_En30
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(35 DOWNTO 0);  -- sfix36_En30
...
BEGIN
  u_dataMEM_im_0_4 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
  ...
  u_dataMEM_re_0_4 : Demodulat_ip_src_SimpleDualPortRAM_generic_block1
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 36
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : Demodulat_ip_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_3_1_vld => dout_3_1_vld,
              xf_re => std_logic_vector(xf_re),  -- sfix36_En30
              xf_im => std_logic_vector(xf_im),  -- sfix36_En30
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix36_En30
              dinf_im => std_logic_vector(dinf_im),  -- sfix36_En30
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix36_En30
              btf1_im => std_logic_vector(btf1_im),  -- sfix36_En30
              btf2_re => std_logic_vector(btf2_re),  -- sfix36_En30
              btf2_im => std_logic_vector(btf2_im),  -- sfix36_En30
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix36_En30
              wrData_im => wrData_im,  -- sfix36_En30
              wrAddr => wrAddr,  -- ufix8
              wrEnb => wrEnb,
              dout_4_1_re => dout_4_1_re_tmp,  -- sfix36_En30
              dout_4_1_im => dout_4_1_im_tmp,  -- sfix36_En30
