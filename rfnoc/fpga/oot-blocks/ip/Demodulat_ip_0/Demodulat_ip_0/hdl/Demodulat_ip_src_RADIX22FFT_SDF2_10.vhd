...
ARCHITECTURE rtl OF Demodulat_ip_src_RADIX22FFT_SDF2_10 IS
  ...
  COMPONENT Demodulat_ip_src_SDFCommutator10
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          xf_im                           :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          dinf_im                         :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          btf1_im                         :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          btf2_re                         :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          btf2_im                         :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
          wrData_im                       :   OUT   std_logic_vector(25 DOWNTO 0);  -- sfix26_En14
  ...
  -- Signals
  SIGNAL dout_9_1_re_signed               : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL din_re                           : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL dout_9_1_im_signed               : signed(24 DOWNTO 0);  -- sfix25_En14
  SIGNAL din_im                           : signed(25 DOWNTO 0);  -- sfix26_En14
  ...
  SIGNAL btf2_im                          : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL btf2_re                          : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL btf1_im                          : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL btf1_re                          : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL dinf_im                          : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL dinf_re                          : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL xf_im                            : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL wrData_im                        : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL wrAddr                           : std_logic_vector(1 DOWNTO 0);  -- ufix2
  SIGNAL wrEnb                            : std_logic;
  SIGNAL x_im                             : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL x_im_signed                      : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL x_im_dly                         : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL wrData_re                        : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL x_re                             : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL x_re_signed                      : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL x_re_dly                         : signed(25 DOWNTO 0);  -- sfix26_En14
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(26 DOWNTO 0);  -- sfix27_En14
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(26 DOWNTO 0);  -- sfix27_En14
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(26 DOWNTO 0);  -- sfix27_En14
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(26 DOWNTO 0);  -- sfix27_En14
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(25 DOWNTO 0);  -- sfix26_En14
...
BEGIN
  ...
  u_SDFCOMMUTATOR_10 : Demodulat_ip_src_SDFCommutator10
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix26_En14
              xf_im => std_logic_vector(xf_im),  -- sfix26_En14
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix26_En14
              dinf_im => std_logic_vector(dinf_im),  -- sfix26_En14
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix26_En14
              btf1_im => std_logic_vector(btf1_im),  -- sfix26_En14
              btf2_re => std_logic_vector(btf2_re),  -- sfix26_En14
              btf2_im => std_logic_vector(btf2_im),  -- sfix26_En14
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix26_En14
              wrData_im => wrData_im,  -- sfix26_En14
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_10_1_re => dout_10_1_re_tmp,  -- sfix26_En14
              dout_10_1_im => dout_10_1_im_tmp,  -- sfix26_En14
