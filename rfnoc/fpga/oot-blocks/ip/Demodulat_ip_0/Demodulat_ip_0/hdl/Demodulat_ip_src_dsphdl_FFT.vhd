-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_src_dsphdl_FFT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_src_dsphdl_FFT
-- Source Path: dsphdl.FFT
-- Hierarchy Level: 3
-- Model version: 8.98
-- 
-- FFT
...
ENTITY Demodulat_ip_src_dsphdl_FFT IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        dataIn_re                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
        dataIn_im                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
        validIn                           :   IN    std_logic;
        dataOut_re                        :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En30
        dataOut_im                        :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En30
        validOut                          :   OUT   std_logic
        );
END Demodulat_ip_src_dsphdl_FFT;


ARCHITECTURE rtl OF Demodulat_ip_src_dsphdl_FFT IS

  -- Component Declarations
  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinXTwdl_1_1_vld                :   IN    std_logic;
          dinXTwdl_1_1_vld_1              :   IN    std_logic;
          rd_1_Addr                       :   OUT   std_logic_vector(10 DOWNTO 0);  -- ufix11
          rd_1_Enb                        :   OUT   std_logic;
          proc_1_enb                      :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_1_1_re_dly                  :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          din_1_1_im_dly                  :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          din_1_vld_dly                   :   IN    std_logic;
          rd_1_Addr                       :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
          rd_1_Enb                        :   IN    std_logic;
          proc_1_enb                      :   IN    std_logic;
          dout_1_1_re                     :   OUT   std_logic_vector(32 DOWNTO 0);  -- sfix33_En30
          dout_1_1_im                     :   OUT   std_logic_vector(32 DOWNTO 0);  -- sfix33_En30
          dout_1_1_vld                    :   OUT   std_logic;
          dinXTwdl_1_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
          dinXTwdl_2_1_vld                :   IN    std_logic;
          rd_2_Addr                       :   OUT   std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF2_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_1_1_re                     :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33_En30
          dout_1_1_im                     :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33_En30
          dout_1_1_vld                    :   IN    std_logic;
          rd_2_Addr                       :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
          rd_2_Enb                        :   IN    std_logic;
          proc_2_enb                      :   IN    std_logic;
          multiply_2_J                    :   IN    std_logic;
          dout_2_1_re                     :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34_En30
          dout_2_1_im                     :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34_En30
          dout_2_1_vld                    :   OUT   std_logic;
          dinXTwdl_2_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_TWDLROM_3_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinXTwdl_3_1_vld                :   IN    std_logic;
          dinXTwdl_3_1_vld_1              :   IN    std_logic;
          rd_3_Addr                       :   OUT   std_logic_vector(8 DOWNTO 0);  -- ufix9
          rd_3_Enb                        :   OUT   std_logic;
          proc_3_enb                      :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_3_1_re_dly                  :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En30
          din_3_1_im_dly                  :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En30
          ...
          dout_3_1_re                     :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35_En30
          dout_3_1_im                     :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35_En30
          dout_3_1_vld                    :   OUT   std_logic;
          dinXTwdl_3_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
          dinXTwdl_4_1_vld                :   IN    std_logic;
          rd_4_Addr                       :   OUT   std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF2_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_3_1_re                     :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En30
          dout_3_1_im                     :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En30
          dout_3_1_vld                    :   IN    std_logic;
          rd_4_Addr                       :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
          rd_4_Enb                        :   IN    std_logic;
          proc_4_enb                      :   IN    std_logic;
          multiply_4_J                    :   IN    std_logic;
          dout_4_1_re                     :   OUT   std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          dout_4_1_im                     :   OUT   std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          dout_4_1_vld                    :   OUT   std_logic;
          dinXTwdl_4_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_TWDLROM_5_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinXTwdl_5_1_vld                :   IN    std_logic;
          dinXTwdl_5_1_vld_1              :   IN    std_logic;
          rd_5_Addr                       :   OUT   std_logic_vector(6 DOWNTO 0);  -- ufix7
          rd_5_Enb                        :   OUT   std_logic;
          proc_5_enb                      :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_5_1_re_dly                  :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          din_5_1_im_dly                  :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En30
          din_5_vld_dly                   :   IN    std_logic;
          rd_5_Addr                       :   IN    std_logic_vector(6 DOWNTO 0);  -- ufix7
          ...
          dout_5_1_re                     :   OUT   std_logic_vector(36 DOWNTO 0);  -- sfix37_En30
          dout_5_1_im                     :   OUT   std_logic_vector(36 DOWNTO 0);  -- sfix37_En30
          dout_5_1_vld                    :   OUT   std_logic;
          dinXTwdl_5_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_5_1_vld                    :   IN    std_logic;
          dinXTwdl_6_1_vld                :   IN    std_logic;
          rd_6_Addr                       :   OUT   std_logic_vector(5 DOWNTO 0);  -- ufix6
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF2_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_5_1_re                     :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37_En30
          dout_5_1_im                     :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37_En30
          dout_5_1_vld                    :   IN    std_logic;
          rd_6_Addr                       :   IN    std_logic_vector(5 DOWNTO 0);  -- ufix6
          rd_6_Enb                        :   IN    std_logic;
          proc_6_enb                      :   IN    std_logic;
          multiply_6_J                    :   IN    std_logic;
          dout_6_1_re                     :   OUT   std_logic_vector(37 DOWNTO 0);  -- sfix38_En30
          dout_6_1_im                     :   OUT   std_logic_vector(37 DOWNTO 0);  -- sfix38_En30
          dout_6_1_vld                    :   OUT   std_logic;
          dinXTwdl_6_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_TWDLROM_7_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinXTwdl_7_1_vld                :   IN    std_logic;
          dinXTwdl_7_1_vld_1              :   IN    std_logic;
          rd_7_Addr                       :   OUT   std_logic_vector(4 DOWNTO 0);  -- ufix5
          rd_7_Enb                        :   OUT   std_logic;
          proc_7_enb                      :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF1_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
          dinXTwdl_8_1_vld                :   IN    std_logic;
          rd_8_Addr                       :   OUT   std_logic_vector(3 DOWNTO 0);  -- ufix4
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF2_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_7_1_re                     :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En30
          dout_7_1_im                     :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En30
          dout_7_1_vld                    :   IN    std_logic;
          rd_8_Addr                       :   IN    std_logic_vector(3 DOWNTO 0);  -- ufix4
          rd_8_Enb                        :   IN    std_logic;
          proc_8_enb                      :   IN    std_logic;
          multiply_8_J                    :   IN    std_logic;
          dout_8_1_re                     :   OUT   std_logic_vector(39 DOWNTO 0);  -- sfix40_En30
          dout_8_1_im                     :   OUT   std_logic_vector(39 DOWNTO 0);  -- sfix40_En30
          dout_8_1_vld                    :   OUT   std_logic;
          dinXTwdl_8_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_TWDLROM_9_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinXTwdl_9_1_vld                :   IN    std_logic;
          dinXTwdl_9_1_vld_1              :   IN    std_logic;
          rd_9_Addr                       :   OUT   std_logic_vector(2 DOWNTO 0);  -- ufix3
          rd_9_Enb                        :   OUT   std_logic;
          proc_9_enb                      :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_9_1_re_dly                  :   IN    std_logic_vector(39 DOWNTO 0);  -- sfix40_En30
          din_9_1_im_dly                  :   IN    std_logic_vector(39 DOWNTO 0);  -- sfix40_En30
          ...
          dout_9_1_re                     :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En30
          dout_9_1_im                     :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En30
          dout_9_1_vld                    :   OUT   std_logic;
          dinXTwdl_9_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
          dinXTwdl_10_1_vld               :   IN    std_logic;
          rd_10_Addr                      :   OUT   std_logic_vector(1 DOWNTO 0);  -- ufix2
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF2_10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_9_1_re                     :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41_En30
          dout_9_1_im                     :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41_En30
          dout_9_1_vld                    :   IN    std_logic;
          rd_10_Addr                      :   IN    std_logic_vector(1 DOWNTO 0);  -- ufix2
          rd_10_Enb                       :   IN    std_logic;
          proc_10_enb                     :   IN    std_logic;
          multiply_10_J                   :   IN    std_logic;
          dout_10_1_re                    :   OUT   std_logic_vector(41 DOWNTO 0);  -- sfix42_En30
          dout_10_1_im                    :   OUT   std_logic_vector(41 DOWNTO 0);  -- sfix42_En30
          dout_10_1_vld                   :   OUT   std_logic;
          dinXTwdl_10_1_vld               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_TWDLROM_11_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF1_11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_11_1_re_dly                 :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En30
          din_11_1_im_dly                 :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En30
          ...
          dout_11_1_re                    :   OUT   std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          dout_11_1_im                    :   OUT   std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          dout_11_1_vld                   :   OUT   std_logic;
          dinXTwdl_11_1_vld               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX22FFT_CTRL1_12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF2_12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_11_1_re                    :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          dout_11_1_im                    :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          dout_11_1_vld                   :   IN    std_logic;
          rd_12_Addr                      :   IN    std_logic;
          rd_12_Enb                       :   IN    std_logic;
          proc_12_enb                     :   IN    std_logic;
          multiply_12_J                   :   IN    std_logic;
          dout_12_1_re                    :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En30
          dout_12_1_im                    :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En30
          dout_12_1_vld                   :   OUT   std_logic;
          dinXTwdl_12_1_vld               :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT Demodulat_ip_src_RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_12_1_re                    :   IN    std_logic_vector(43 DOWNTO 0);  -- sfix44_En30
          dout_12_1_im                    :   IN    std_logic_vector(43 DOWNTO 0);  -- sfix44_En30
          dout_12_1_vld                   :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En30
          dout_im1                        :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En30
          dout_vld1                       :   OUT   std_logic
          );
  END COMPONENT;

  -- Component Configuration Statements
  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_1
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_1(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF1_1
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF1_1(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_2
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_2(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF2_2
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF2_2(rtl);

  FOR ALL : Demodulat_ip_src_TWDLROM_3_1
    USE ENTITY work.Demodulat_ip_src_TWDLROM_3_1(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_3
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_3(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF1_3
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF1_3(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_4
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_4(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF2_4
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF2_4(rtl);

  FOR ALL : Demodulat_ip_src_TWDLROM_5_1
    USE ENTITY work.Demodulat_ip_src_TWDLROM_5_1(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_5
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_5(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF1_5
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF1_5(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_6
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_6(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF2_6
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF2_6(rtl);

  FOR ALL : Demodulat_ip_src_TWDLROM_7_1
    USE ENTITY work.Demodulat_ip_src_TWDLROM_7_1(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_7
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_7(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF1_7
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF1_7(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_8
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_8(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF2_8
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF2_8(rtl);

  FOR ALL : Demodulat_ip_src_TWDLROM_9_1
    USE ENTITY work.Demodulat_ip_src_TWDLROM_9_1(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_9
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_9(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF1_9
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF1_9(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_10
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_10(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF2_10
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF2_10(rtl);

  FOR ALL : Demodulat_ip_src_TWDLROM_11_1
    USE ENTITY work.Demodulat_ip_src_TWDLROM_11_1(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_11
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_11(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF1_11
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF1_11(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_CTRL1_12
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_CTRL1_12(rtl);

  FOR ALL : Demodulat_ip_src_RADIX22FFT_SDF2_12
    USE ENTITY work.Demodulat_ip_src_RADIX22FFT_SDF2_12(rtl);

  FOR ALL : Demodulat_ip_src_RADIX2FFT_bitNatural
    USE ENTITY work.Demodulat_ip_src_RADIX2FFT_bitNatural(rtl);

  -- Signals
  SIGNAL softReset                        : std_logic;
  SIGNAL dataIn_re_signed                 : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL dataIn_im_signed                 : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL intdelay_reg                     : vector_of_signed32(0 TO 2);  -- sfix32 [3]
  SIGNAL din_1_1_re_dly                   : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL intdelay_reg_1                   : vector_of_signed32(0 TO 2);  -- sfix32 [3]
  SIGNAL din_1_1_im_dly                   : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL intdelay_reg_2                   : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  SIGNAL din_1_vld_dly                    : std_logic;
  SIGNAL dinXTwdl_1_1_vld                 : std_logic;
  SIGNAL rd_1_Addr                        : std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  SIGNAL rd_2_Addr                        : std_logic_vector(9 DOWNTO 0);  -- ufix10
  ...
  SIGNAL dout_2_1_re_signed               : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL dout_2_1_im_signed               : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL intdelay_reg_3                   : vector_of_signed34(0 TO 2);  -- sfix34 [3]
  SIGNAL din_3_1_re_dly                   : signed(33 DOWNTO 0);  -- sfix34_En30
  SIGNAL intdelay_reg_4                   : vector_of_signed34(0 TO 2);  -- sfix34 [3]
  SIGNAL din_3_1_im_dly                   : signed(33 DOWNTO 0);  -- sfix34_En30
  ...
  SIGNAL rd_3_Addr                        : std_logic_vector(8 DOWNTO 0);  -- ufix9
  ...
  SIGNAL rd_4_Addr                        : std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL dout_4_1_re_signed               : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL dout_4_1_im_signed               : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL intdelay_reg_6                   : vector_of_signed36(0 TO 2);  -- sfix36 [3]
  SIGNAL din_5_1_re_dly                   : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL intdelay_reg_7                   : vector_of_signed36(0 TO 2);  -- sfix36 [3]
  SIGNAL din_5_1_im_dly                   : signed(35 DOWNTO 0);  -- sfix36_En30
  ...
  SIGNAL rd_5_Addr                        : std_logic_vector(6 DOWNTO 0);  -- ufix7
  ...
  SIGNAL rd_6_Addr                        : std_logic_vector(5 DOWNTO 0);  -- ufix6
  ...
  SIGNAL dout_6_1_re_signed               : signed(37 DOWNTO 0);  -- sfix38_En30
  SIGNAL dout_6_1_im_signed               : signed(37 DOWNTO 0);  -- sfix38_En30
  SIGNAL intdelay_reg_9                   : vector_of_signed38(0 TO 2);  -- sfix38 [3]
  SIGNAL din_7_1_re_dly                   : signed(37 DOWNTO 0);  -- sfix38_En30
  SIGNAL intdelay_reg_10                  : vector_of_signed38(0 TO 2);  -- sfix38 [3]
  SIGNAL din_7_1_im_dly                   : signed(37 DOWNTO 0);  -- sfix38_En30
  ...
  SIGNAL rd_7_Addr                        : std_logic_vector(4 DOWNTO 0);  -- ufix5
  ...
  SIGNAL rd_8_Addr                        : std_logic_vector(3 DOWNTO 0);  -- ufix4
  ...
  SIGNAL dout_8_1_re_signed               : signed(39 DOWNTO 0);  -- sfix40_En30
  SIGNAL dout_8_1_im_signed               : signed(39 DOWNTO 0);  -- sfix40_En30
  SIGNAL intdelay_reg_12                  : vector_of_signed40(0 TO 2);  -- sfix40 [3]
  SIGNAL din_9_1_re_dly                   : signed(39 DOWNTO 0);  -- sfix40_En30
  SIGNAL intdelay_reg_13                  : vector_of_signed40(0 TO 2);  -- sfix40 [3]
  SIGNAL din_9_1_im_dly                   : signed(39 DOWNTO 0);  -- sfix40_En30
  ...
  SIGNAL rd_9_Addr                        : std_logic_vector(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL rd_10_Addr                       : std_logic_vector(1 DOWNTO 0);  -- ufix2
  ...
  SIGNAL dout_10_1_re_signed              : signed(41 DOWNTO 0);  -- sfix42_En30
  SIGNAL dout_10_1_im_signed              : signed(41 DOWNTO 0);  -- sfix42_En30
  SIGNAL intdelay_reg_15                  : vector_of_signed42(0 TO 2);  -- sfix42 [3]
  SIGNAL din_11_1_re_dly                  : signed(41 DOWNTO 0);  -- sfix42_En30
  SIGNAL intdelay_reg_16                  : vector_of_signed42(0 TO 2);  -- sfix42 [3]
  SIGNAL din_11_1_im_dly                  : signed(41 DOWNTO 0);  -- sfix42_En30
  SIGNAL intdelay_reg_17                  : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  SIGNAL din_11_vld_dly                   : std_logic;
  SIGNAL twdl_11_1_re                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL twdl_11_1_im                     : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL dout_11_1_re                     : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL dout_11_1_im                     : std_logic_vector(42 DOWNTO 0);  -- ufix43
  ...
  SIGNAL dout_12_1_re                     : std_logic_vector(43 DOWNTO 0);  -- ufix44
  SIGNAL dout_12_1_im                     : std_logic_vector(43 DOWNTO 0);  -- ufix44
  SIGNAL dout_12_1_vld                    : std_logic;
  SIGNAL dout_re1                         : std_logic_vector(43 DOWNTO 0);  -- ufix44
  SIGNAL dout_im1                         : std_logic_vector(43 DOWNTO 0);  -- ufix44
  SIGNAL dout_vld1                        : std_logic;

BEGIN
  u_CTRL1_1_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_1_1 : Demodulat_ip_src_RADIX22FFT_SDF1_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_1_1_re_dly => std_logic_vector(din_1_1_re_dly),  -- sfix32_En30
              din_1_1_im_dly => std_logic_vector(din_1_1_im_dly),  -- sfix32_En30
              din_1_vld_dly => din_1_vld_dly,
              rd_1_Addr => rd_1_Addr,  -- ufix11
              rd_1_Enb => rd_1_Enb,
              proc_1_enb => proc_1_enb,
              dout_1_1_re => dout_1_1_re,  -- sfix33_En30
              dout_1_1_im => dout_1_1_im,  -- sfix33_En30
              dout_1_1_vld => dout_1_1_vld,
              dinXTwdl_1_1_vld => dinXTwdl_1_1_vld
              );

  u_CTRL2_2_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : Demodulat_ip_src_RADIX22FFT_SDF2_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_1_1_re => dout_1_1_re,  -- sfix33_En30
              ...
              proc_2_enb => proc_2_enb,
              multiply_2_J => multiply_2_J,
              dout_2_1_re => dout_2_1_re,  -- sfix34_En30
              dout_2_1_im => dout_2_1_im,  -- sfix34_En30
              dout_2_1_vld => dout_2_1_vld,
              dinXTwdl_2_1_vld => dinXTwdl_2_1_vld
              );

  u_twdlROM_3_1 : Demodulat_ip_src_TWDLROM_3_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_2_1_vld => dout_2_1_vld,
  ...
  u_CTRL1_3_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_3_1 : Demodulat_ip_src_RADIX22FFT_SDF1_3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_3_1_re_dly => std_logic_vector(din_3_1_re_dly),  -- sfix34_En30
              din_3_1_im_dly => std_logic_vector(din_3_1_im_dly),  -- sfix34_En30
              ...
              twdl_3_1_im => twdl_3_1_im,  -- sfix32_En30
              proc_3_enb => proc_3_enb,
              dout_3_1_re => dout_3_1_re,  -- sfix35_En30
              dout_3_1_im => dout_3_1_im,  -- sfix35_En30
              dout_3_1_vld => dout_3_1_vld,
              dinXTwdl_3_1_vld => dinXTwdl_3_1_vld
              );

  u_CTRL2_4_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : Demodulat_ip_src_RADIX22FFT_SDF2_4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_3_1_re => dout_3_1_re,  -- sfix35_En30
              ...
              proc_4_enb => proc_4_enb,
              multiply_4_J => multiply_4_J,
              dout_4_1_re => dout_4_1_re,  -- sfix36_En30
              dout_4_1_im => dout_4_1_im,  -- sfix36_En30
              dout_4_1_vld => dout_4_1_vld,
              dinXTwdl_4_1_vld => dinXTwdl_4_1_vld
              );

  u_twdlROM_5_1 : Demodulat_ip_src_TWDLROM_5_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_4_1_vld => dout_4_1_vld,
  ...
  u_CTRL1_5_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_5_1 : Demodulat_ip_src_RADIX22FFT_SDF1_5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_5_1_re_dly => std_logic_vector(din_5_1_re_dly),  -- sfix36_En30
              din_5_1_im_dly => std_logic_vector(din_5_1_im_dly),  -- sfix36_En30
              ...
              twdl_5_1_im => twdl_5_1_im,  -- sfix32_En30
              proc_5_enb => proc_5_enb,
              dout_5_1_re => dout_5_1_re,  -- sfix37_En30
              dout_5_1_im => dout_5_1_im,  -- sfix37_En30
              dout_5_1_vld => dout_5_1_vld,
              dinXTwdl_5_1_vld => dinXTwdl_5_1_vld
              );

  u_CTRL2_6_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : Demodulat_ip_src_RADIX22FFT_SDF2_6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_5_1_re => dout_5_1_re,  -- sfix37_En30
              ...
              proc_6_enb => proc_6_enb,
              multiply_6_J => multiply_6_J,
              dout_6_1_re => dout_6_1_re,  -- sfix38_En30
              dout_6_1_im => dout_6_1_im,  -- sfix38_En30
              dout_6_1_vld => dout_6_1_vld,
              dinXTwdl_6_1_vld => dinXTwdl_6_1_vld
              );

  u_twdlROM_7_1 : Demodulat_ip_src_TWDLROM_7_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_6_1_vld => dout_6_1_vld,
  ...
  u_CTRL1_7_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_7_1 : Demodulat_ip_src_RADIX22FFT_SDF1_7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_7_1_re_dly => std_logic_vector(din_7_1_re_dly),  -- sfix38_En30
              din_7_1_im_dly => std_logic_vector(din_7_1_im_dly),  -- sfix38_En30
              ...
              twdl_7_1_im => twdl_7_1_im,  -- sfix32_En30
              proc_7_enb => proc_7_enb,
              dout_7_1_re => dout_7_1_re,  -- sfix39_En30
              dout_7_1_im => dout_7_1_im,  -- sfix39_En30
              dout_7_1_vld => dout_7_1_vld,
              dinXTwdl_7_1_vld => dinXTwdl_7_1_vld
              );

  u_CTRL2_8_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_7_1_vld => dout_7_1_vld,
  ...
  u_SDF2_8_1 : Demodulat_ip_src_RADIX22FFT_SDF2_8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_7_1_re => dout_7_1_re,  -- sfix39_En30
              ...
              proc_8_enb => proc_8_enb,
              multiply_8_J => multiply_8_J,
              dout_8_1_re => dout_8_1_re,  -- sfix40_En30
              dout_8_1_im => dout_8_1_im,  -- sfix40_En30
              dout_8_1_vld => dout_8_1_vld,
              dinXTwdl_8_1_vld => dinXTwdl_8_1_vld
              );

  u_twdlROM_9_1 : Demodulat_ip_src_TWDLROM_9_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_8_1_vld => dout_8_1_vld,
  ...
  u_CTRL1_9_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_9_1 : Demodulat_ip_src_RADIX22FFT_SDF1_9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_9_1_re_dly => std_logic_vector(din_9_1_re_dly),  -- sfix40_En30
              din_9_1_im_dly => std_logic_vector(din_9_1_im_dly),  -- sfix40_En30
              ...
              twdl_9_1_im => twdl_9_1_im,  -- sfix32_En30
              proc_9_enb => proc_9_enb,
              dout_9_1_re => dout_9_1_re,  -- sfix41_En30
              dout_9_1_im => dout_9_1_im,  -- sfix41_En30
              dout_9_1_vld => dout_9_1_vld,
              dinXTwdl_9_1_vld => dinXTwdl_9_1_vld
              );

  u_CTRL2_10_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_9_1_vld => dout_9_1_vld,
  ...
  u_SDF2_10_1 : Demodulat_ip_src_RADIX22FFT_SDF2_10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_9_1_re => dout_9_1_re,  -- sfix41_En30
              ...
              proc_10_enb => proc_10_enb,
              multiply_10_J => multiply_10_J,
              dout_10_1_re => dout_10_1_re,  -- sfix42_En30
              dout_10_1_im => dout_10_1_im,  -- sfix42_En30
              dout_10_1_vld => dout_10_1_vld,
              dinXTwdl_10_1_vld => dinXTwdl_10_1_vld
              );

  u_twdlROM_11_1 : Demodulat_ip_src_TWDLROM_11_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_10_1_vld => dout_10_1_vld,
  ...
  u_CTRL1_11_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_11_1 : Demodulat_ip_src_RADIX22FFT_SDF1_11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_11_1_re_dly => std_logic_vector(din_11_1_re_dly),  -- sfix42_En30
              din_11_1_im_dly => std_logic_vector(din_11_1_im_dly),  -- sfix42_En30
              ...
              twdl_11_1_im => twdl_11_1_im,  -- sfix32_En30
              proc_11_enb => proc_11_enb,
              dout_11_1_re => dout_11_1_re,  -- sfix43_En30
              dout_11_1_im => dout_11_1_im,  -- sfix43_En30
              dout_11_1_vld => dout_11_1_vld,
              dinXTwdl_11_1_vld => dinXTwdl_11_1_vld
              );

  u_CTRL2_12_1 : Demodulat_ip_src_RADIX22FFT_CTRL1_12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_11_1_vld => dout_11_1_vld,
  ...
  u_SDF2_12_1 : Demodulat_ip_src_RADIX22FFT_SDF2_12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_11_1_re => dout_11_1_re,  -- sfix43_En30
              ...
              proc_12_enb => proc_12_enb,
              multiply_12_J => multiply_12_J,
              dout_12_1_re => dout_12_1_re,  -- sfix44_En30
              dout_12_1_im => dout_12_1_im,  -- sfix44_En30
              dout_12_1_vld => dout_12_1_vld,
              dinXTwdl_12_1_vld => dinXTwdl_12_1_vld
              );

  u_NaturalOrder_Stage : Demodulat_ip_src_RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_12_1_re => dout_12_1_re,  -- sfix44_En30
              dout_12_1_im => dout_12_1_im,  -- sfix44_En30
              dout_12_1_vld => dout_12_1_vld,
              dout_re1 => dout_re1,  -- sfix44_En30
              dout_im1 => dout_im1,  -- sfix44_En30
              dout_vld1 => dout_vld1
              );
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_15 <= (OTHERS => to_signed(0, 42));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_15 <= (OTHERS => to_signed(0, 42));
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_16 <= (OTHERS => to_signed(0, 42));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_16 <= (OTHERS => to_signed(0, 42));
