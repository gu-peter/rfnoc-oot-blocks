...
ARCHITECTURE rtl OF Demodulat_ip_src_dsphdl_FFT IS
  ...
  COMPONENT Demodulat_ip_src_RADIX22FFT_SDF2_12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_11_1_re                    :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En14
          dout_11_1_im                    :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En14
          dout_11_1_vld                   :   IN    std_logic;
          rd_12_Addr                      :   IN    std_logic;
          rd_12_Enb                       :   IN    std_logic;
          proc_12_enb                     :   IN    std_logic;
          multiply_12_J                   :   IN    std_logic;
          dout_12_1_re                    :   OUT   std_logic_vector(27 DOWNTO 0);  -- sfix28_En14
          dout_12_1_im                    :   OUT   std_logic_vector(27 DOWNTO 0);  -- sfix28_En14
  ...
  COMPONENT Demodulat_ip_src_RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_12_1_re                    :   IN    std_logic_vector(27 DOWNTO 0);  -- sfix28_En14
          dout_12_1_im                    :   IN    std_logic_vector(27 DOWNTO 0);  -- sfix28_En14
          dout_12_1_vld                   :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(27 DOWNTO 0);  -- sfix28_En14
          dout_im1                        :   OUT   std_logic_vector(27 DOWNTO 0);  -- sfix28_En14
  ...
  SIGNAL dout_10_1_re_signed              : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL dout_10_1_im_signed              : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL intdelay_reg_15                  : vector_of_signed26(0 TO 2);  -- sfix26 [3]
  SIGNAL din_11_1_re_dly                  : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL intdelay_reg_16                  : vector_of_signed26(0 TO 2);  -- sfix26 [3]
  SIGNAL din_11_1_im_dly                  : signed(25 DOWNTO 0);  -- sfix26_En14
  SIGNAL intdelay_reg_17                  : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  SIGNAL din_11_vld_dly                   : std_logic;
  SIGNAL twdl_11_1_re                     : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdl_11_1_im                     : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL dout_11_1_re                     : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL dout_11_1_im                     : std_logic_vector(26 DOWNTO 0);  -- ufix27
  ...
  SIGNAL dout_12_1_re                     : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL dout_12_1_im                     : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL dout_12_1_vld                    : std_logic;
  SIGNAL dout_re1                         : std_logic_vector(27 DOWNTO 0);  -- ufix28
  SIGNAL dout_im1                         : std_logic_vector(27 DOWNTO 0);  -- ufix28
...
BEGIN
  ...
  u_SDF1_11_1 : Demodulat_ip_src_RADIX22FFT_SDF1_11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_11_1_re_dly => std_logic_vector(din_11_1_re_dly),  -- sfix26_En14
              din_11_1_im_dly => std_logic_vector(din_11_1_im_dly),  -- sfix26_En14
              ...
              twdl_11_1_im => twdl_11_1_im,  -- sfix16_En14
              proc_11_enb => proc_11_enb,
              dout_11_1_re => dout_11_1_re,  -- sfix27_En14
              dout_11_1_im => dout_11_1_im,  -- sfix27_En14
  ...
  u_SDF2_12_1 : Demodulat_ip_src_RADIX22FFT_SDF2_12
    PORT MAP( clk => clk,
              ...
              proc_12_enb => proc_12_enb,
              multiply_12_J => multiply_12_J,
              dout_12_1_re => dout_12_1_re,  -- sfix28_En14
              dout_12_1_im => dout_12_1_im,  -- sfix28_En14
  ...
  u_NaturalOrder_Stage : Demodulat_ip_src_RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              ...
              dout_12_1_im => dout_12_1_im,  -- sfix28_En14
              dout_12_1_vld => dout_12_1_vld,
              dout_re1 => dout_re1,  -- sfix28_En14
              dout_im1 => dout_im1,  -- sfix28_En14
              dout_vld1 => dout_vld1
              );
