-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/genhdlOFDMDemodulatorChEstModel/Demodulat_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Demodulat_ip_fifo_TLAST_OUT
-- Source Path: Demodulat_ip/Demodulat_ip_axis_a_master/Demodulat_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Demodulat_ip_fifo_TLAST_OUT IS
...
END Demodulat_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF Demodulat_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT Demodulat_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : Demodulat_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.Demodulat_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_Demodulat_ip_fifo_TLAST_OUT_classic_ram_singlebit : Demodulat_ip_SimpleDualPortRAM_singlebit
