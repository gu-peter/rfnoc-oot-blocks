...
ENTITY Demodulat_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        AXIS_A_Slave_TDATA                :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
...
ARCHITECTURE rtl OF Demodulat_ip IS
  ...
  SIGNAL AXIS_A_Slave_TDATA_unsigned      : unsigned(63 DOWNTO 0);  -- ufix64
  SIGNAL AXIS_A_Slave_TDATA_0             : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL AXIS_A_Slave_TDATA_1             : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL AXIS_A_Slave_TDATA_Vec           : vector_of_unsigned32(0 TO 1);  -- ufix32 [2]
  SIGNAL AXIS_A_Slave_TDATA_Vec_1         : vector_of_std_logic_vector32(0 TO 1);  -- ufix32 [2]
  ...
  SIGNAL top_user_data                    : vector_of_std_logic_vector32(0 TO 1);  -- ufix32 [2]
  SIGNAL top_user_data_1_1                : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL In1_im_sig                       : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL auto_ready_axis_a_master         : std_logic;  -- ufix1
  SIGNAL top_user_valid                   : std_logic;  -- ufix1
  SIGNAL top_user_data_0                  : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL In1_re_sig                       : signed(31 DOWNTO 0);  -- sfix32_En30
...
BEGIN
  ...
  u_Demodulat_ip_axis_a_slave_inst : Demodulat_ip_axis_a_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
              AXIS_A_Slave_TDATA => AXIS_A_Slave_TDATA_Vec_1,  -- ufix32 [2]
              ...
              user_data => top_user_data,  -- ufix32 [2]
  ...
  u_Demodulat_ip_dut_inst : Demodulat_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              ...
              In1_re => std_logic_vector(In1_re_sig),  -- sfix32_En30
              In1_im => std_logic_vector(In1_im_sig),  -- sfix32_En30
  ...
  AXIS_A_Slave_TDATA_0 <= AXIS_A_Slave_TDATA_unsigned(31 DOWNTO 0);

  AXIS_A_Slave_TDATA_1 <= AXIS_A_Slave_TDATA_unsigned(63 DOWNTO 32);
