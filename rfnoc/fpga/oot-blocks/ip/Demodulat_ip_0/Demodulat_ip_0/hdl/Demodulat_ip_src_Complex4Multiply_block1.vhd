...
ARCHITECTURE rtl OF Demodulat_ip_src_Complex4Multiply_block1 IS
  ...
  SIGNAL prod1_re                         : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En28
  SIGNAL prod1_im                         : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En28
  SIGNAL prod2_re                         : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En28
  SIGNAL prod2_im                         : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En28
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL Complex4Add_sub_cast             : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL Complex4Add_sub_cast_1           : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL Complex4Add_add_cast             : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL Complex4Add_add_cast_1           : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL mulResFP_re                      : signed(39 DOWNTO 0);  -- sfix40_En28
  SIGNAL mulResFP_im                      : signed(39 DOWNTO 0);  -- sfix40_En28
