...
ARCHITECTURE rtl OF Demodulat_ip_src_RADIX22FFT_SDF1_11 IS
  ...
  COMPONENT Demodulat_ip_src_Complex4Multiply_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_re                          :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          din_im                          :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          din_11_vld_dly                  :   IN    std_logic;
          twdl_11_1_re                    :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          twdl_11_1_im                    :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          dinXTwdl_re                     :   OUT   std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          dinXTwdl_im                     :   OUT   std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          dinXTwdl_11_1_vld               :   OUT   std_logic
          );
  END COMPONENT;
  ...
  COMPONENT Demodulat_ip_src_SDFCommutator11
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          xf_im                           :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          dinXTwdlf_im                    :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          btf1_im                         :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          btf2_re                         :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          btf2_im                         :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
          wrData_im                       :   OUT   std_logic_vector(42 DOWNTO 0);  -- sfix43_En30
  ...
  -- Signals
  SIGNAL din_11_1_re_dly_signed           : signed(41 DOWNTO 0);  -- sfix42_En30
  SIGNAL din_re                           : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL din_11_1_im_dly_signed           : signed(41 DOWNTO 0);  -- sfix42_En30
  SIGNAL din_im                           : signed(42 DOWNTO 0);  -- sfix43_En30
  ...
  SIGNAL dinXTwdl_re_signed               : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL dinXTwdl_im_signed               : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL btf2_re                          : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL btf1_im                          : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL btf1_re                          : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL dinXTwdlf_im                     : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL dinXTwdlf_re                     : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL xf_im                            : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL wrData_im                        : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL wrData_im_signed                 : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL wrData_re                        : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL wrData_re_signed                 : signed(42 DOWNTO 0);  -- sfix43_En30
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL x_re                             : signed(42 DOWNTO 0);  -- sfix43_En30
  SIGNAL x_im                             : signed(42 DOWNTO 0);  -- sfix43_En30
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_add_cast      : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL xf_re                            : signed(42 DOWNTO 0);  -- sfix43_En30
...
BEGIN
  u_MUL4 : Demodulat_ip_src_Complex4Multiply_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_re => std_logic_vector(din_re),  -- sfix43_En30
              din_im => std_logic_vector(din_im),  -- sfix43_En30
              din_11_vld_dly => din_11_vld_dly,
              twdl_11_1_re => twdl_11_1_re,  -- sfix32_En30
              twdl_11_1_im => twdl_11_1_im,  -- sfix32_En30
              dinXTwdl_re => dinXTwdl_re,  -- sfix43_En30
              dinXTwdl_im => dinXTwdl_im,  -- sfix43_En30
  ...
  u_SDFCOMMUTATOR_11 : Demodulat_ip_src_SDFCommutator11
    PORT MAP( clk => clk,
              ...
              enb => enb,
              din_11_vld_dly => din_11_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix43_En30
              xf_im => std_logic_vector(xf_im),  -- sfix43_En30
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix43_En30
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix43_En30
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix43_En30
              btf1_im => std_logic_vector(btf1_im),  -- sfix43_En30
              btf2_re => std_logic_vector(btf2_re),  -- sfix43_En30
              btf2_im => std_logic_vector(btf2_im),  -- sfix43_En30
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix43_En30
              wrData_im => wrData_im,  -- sfix43_En30
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_11_1_re => dout_11_1_re_tmp,  -- sfix43_En30
              dout_11_1_im => dout_11_1_im_tmp,  -- sfix43_En30
