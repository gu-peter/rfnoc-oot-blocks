...
ARCHITECTURE rtl OF Demodulat_ip_src_OFDM_Demodulator IS
  ...
  COMPONENT Demodulat_ip_src_HDLFFTShift
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          varargout_1_re                  :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          varargout_1_im                  :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          varargout_2                     :   IN    std_logic;
          varargout_1_re_1                :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          varargout_1_im_1                :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
  ...
  SIGNAL varargout_1_re                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL varargout_1_im                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL varargout_2                      : std_logic;
  SIGNAL varargout_1_re_1                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL varargout_1_im_1                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL varargout_2_1                    : std_logic;
  SIGNAL varargout_1_re_2                 : std_logic_vector(43 DOWNTO 0);  -- ufix44
  SIGNAL varargout_1_im_2                 : std_logic_vector(43 DOWNTO 0);  -- ufix44
  SIGNAL varargout_2_2                    : std_logic;
  SIGNAL varargout_1_re_3                 : std_logic_vector(43 DOWNTO 0);  -- ufix44
  SIGNAL varargout_1_im_3                 : std_logic_vector(43 DOWNTO 0);  -- ufix44
  ...
  SIGNAL obj_dataOut_re                   : signed(43 DOWNTO 0);  -- sfix44_En30
  SIGNAL obj_dataOut_im                   : signed(43 DOWNTO 0);  -- sfix44_En30
...
BEGIN
  u_CPRemoval_stage1 : Demodulat_ip_src_CPRemoval_stage1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              tmp_re => data_re,  -- sfix32_En30
              tmp_im => data_im,  -- sfix32_En30
              tmp => valid,
              tmp_1 => std_logic_vector(obj_cpFracValue),  -- ufix16_En15
              varargout_1_re => varargout_1_re,  -- sfix32_En30
              varargout_1_im => varargout_1_im,  -- sfix32_En30
  ...
  u_HDLFFTShift : Demodulat_ip_src_HDLFFTShift
    PORT MAP( clk => clk,
              ...
              varargout_1_im => varargout_1_im,  -- sfix32_En30
              varargout_2 => varargout_2,
              varargout_1_re_1 => varargout_1_re_1,  -- sfix32_En30
              varargout_1_im_1 => varargout_1_im_1,  -- sfix32_En30
  ...
  u_dsphdl_FFT : Demodulat_ip_src_dsphdl_FFT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dataIn_re => varargout_1_re_1,  -- sfix32_En30
              dataIn_im => varargout_1_im_1,  -- sfix32_En30
              validIn => varargout_2_1,
              dataOut_re => varargout_1_re_2,  -- sfix44_En30
              dataOut_im => varargout_1_im_2,  -- sfix44_En30
  ...
  u_SubcarrierSelector : Demodulat_ip_src_SubcarrierSelector
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              varargout_1_re => varargout_1_re_2,  -- sfix44_En30
              varargout_1_im => varargout_1_im_2,  -- sfix44_En30
              varargout_2 => varargout_2_2,
              varargout_1_re_1 => varargout_1_re_3,  -- sfix44_En30
              varargout_1_im_1 => varargout_1_im_3,  -- sfix44_En30
  ...
  BEGIN
    IF reset = '1' THEN
      obj_dataOut_re <= to_signed(0, 44);
      obj_dataOut_im <= to_signed(0, 44);
