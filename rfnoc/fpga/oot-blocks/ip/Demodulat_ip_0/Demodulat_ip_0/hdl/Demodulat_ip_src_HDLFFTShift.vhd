...
ARCHITECTURE rtl OF Demodulat_ip_src_HDLFFTShift IS
  ...
  SIGNAL varargout_1_re_signed            : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL varargout_1_im_signed            : signed(31 DOWNTO 0);  -- sfix32_En30
  ...
  SIGNAL tmp_4                            : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL yfi                              : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL p28yfi_cast                      : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL p28yfi_cast_1                    : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL tmp_5                            : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_6                            : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_FFTShiftTDObj_rePart         : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_7                            : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_FFTShiftTDObj_rePart_1       : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_8                            : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_9                            : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL yfi_1                            : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL p27yfi_cast                      : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL p27yfi_cast_1                    : signed(32 DOWNTO 0);  -- sfix33_En30
  SIGNAL tmp_10                           : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_11                           : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_FFTShiftTDObj_imPart         : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL tmp_12                           : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL obj_FFTShiftTDObj_imPart_1       : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL varargout_1_re_tmp               : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL varargout_1_im_tmp               : signed(31 DOWNTO 0);  -- sfix32_En30
...
BEGIN
  ...
  p28yfi_cast <= resize(varargout_1_re_signed, 33);
  p28yfi_cast_1 <=  - (p28yfi_cast);
  
  yfi <= X"7FFFFFFF" WHEN (p28yfi_cast_1(32) = '0') AND (p28yfi_cast_1(31) /= '0') ELSE
      X"80000000" WHEN (p28yfi_cast_1(32) = '1') AND (p28yfi_cast_1(31) /= '1') ELSE
      p28yfi_cast_1(31 DOWNTO 0);
  ...
  obj_FFTShiftTDObj_rePart <= to_signed(0, 32);
  ...
  BEGIN
    IF reset = '1' THEN
      obj_FFTShiftTDObj_rePart_1 <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  p27yfi_cast <= resize(varargout_1_im_signed, 33);
  p27yfi_cast_1 <=  - (p27yfi_cast);
  
  yfi_1 <= X"7FFFFFFF" WHEN (p27yfi_cast_1(32) = '0') AND (p27yfi_cast_1(31) /= '0') ELSE
      X"80000000" WHEN (p27yfi_cast_1(32) = '1') AND (p27yfi_cast_1(31) /= '1') ELSE
      p27yfi_cast_1(31 DOWNTO 0);
  ...
  obj_FFTShiftTDObj_imPart <= to_signed(0, 32);
  ...
  BEGIN
    IF reset = '1' THEN
      obj_FFTShiftTDObj_imPart_1 <= to_signed(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
